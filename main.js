...
let main_menu_map = [
  ...
  9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,
  9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,
  9,9,9,3,3,3,3,3,9,9,9,9,9,9,9,9,3,3,3,3,3,9,9,9,
  9,9,9,3,3,3,3,3,9,9,9,9,9,9,9,9,3,3,3,3,3,9,9,9,
  9,9,9,3,3,8,3,3,9,9,9,9,9,9,9,9,3,3,8,3,3,9,9,9,
  9,9,9,3,3,3,3,3,9,9,9,9,9,9,9,9,3,3,3,3,3,9,9,9,
  9,9,9,3,3,3,3,3,9,9,9,9,9,9,9,9,3,3,3,3,3,9,9,9,
  9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,
  9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,
  ...
  for (let y = 0; y < rows; y++) {
    for (let x = 0; x < cols; x++) {
      if(gameMap === fire_shooty_map){
        ...
        } else if(warning && (x === fireColumn || y === fireRow) && (fire_shooty_map[index] === 3)){
          ctx.fillStyle = colors[2];
        } else {
          ctx.fillStyle = colors[fire_shooty_map[index]];
        }
      } else if(gameMap === main_menu_map){
        ctx.fillStyle = colors[main_menu_map[index]];
      }
